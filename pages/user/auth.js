            ...
            <View style={{ width: "100%", flex: 1 }}>
              ...
              >
                <TouchableOpacity
                  style={{
                    width: "50%",
                    backgroundColor: version.loggin.bc,
                    height: 40,
                ...
                >
                  <Text style={{ color: version.loggin.tc, fontSize: 17 }}>
                    Login
                  </Text>
                </TouchableOpacity>
                <TouchableOpacity
                  style={{
                    width: "50%",
                    backgroundColor: version.regg.bc,
                    height: 40,
                    justifyContent: "center",
                    alignItems: "center",
                    borderBottomColor: "black",
                ...
                >
                  <Text style={{ color: version.regg.tc, fontSize: 17 }}>
                    Register
                  </Text>
                </TouchableOpacity>
              </View>
              ...
              <Login
                disp={version.loggin.dip}
                nav={navigation}
                title={version.Name}
              />
              <Register 
                disp={version.regg.dip}
                nav={navigation}
                title={version.Name}
              />
              </KeyboardAwareScrollView>
...
//               password
//             }
//             await fetch('https://61dd-102-91-4-97.eu.ngrok.io/login',{
//               method:'POST',
//               headers:{
